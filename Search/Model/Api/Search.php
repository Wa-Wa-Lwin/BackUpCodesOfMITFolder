...
namespace MIT\Search\Model\Api;

use MIT\Search\Api\SearchInterface;
...
class Search implements SearchInterface
{
    ...
    /**
     * @var CustomProductInterface
     */
    private $customProductInterface;

    /**
     * @var CustomProductSearchResultsInterfaceFactory
     */
    private $customProductSearchResultsInterfaceFactory;
     ...
     * @param CustomProductInterface $customProductInterface
    ...
    public function __construct(
        ...
        CustomProductInterface $customProductInterface,
        SearchCriteriaBuilder $searchCriteriaBuilder,
        FilterGroupBuilder $filterGroupBuilder,
        FilterBuilder $filterBuilder,
        CustomProductSearchResultsInterfaceFactory $customProductSearchResultsInterfaceFactory
    ) {
        ...
        $this->customProductInterface = $customProductInterface;
        $this->customProductSearchResultsInterfaceFactory = $customProductSearchResultsInterfaceFactory;
    }
    ...
    public function search(SearchCriteriaInterface $searchCriteria)
    {
        ...
        $productIdArr = [];
        $productItemList = [];
        $productSearchResultInterface = $this->customProductSearchResultsInterfaceFactory->create();
        foreach ($searchResultInterface->getItems() as $document) {
            $productIdArr[] = $document->getId();
        }
        ...
        if (count($productIdArr) > 0) {
            ...
            $productSearchResultInterface = $this->customProductInterface->getList($searchCriteriaData);
        ...
        $productSearchResultInterface->setTotalCount($searchResultInterface->getTotalCount());
