...
namespace MIT\Queue\Data\Form\Element;
...
class Imagedata extends \Magento\Framework\Data\Form\Element\AbstractElement
{
    /**
     * @var UrlInterface
     */
    ...
    public function getElementHtml()
    {
        ...
        if ((string)$this->getValue()) {
            ...
            if (!preg_match("/^http\:\/\/|https\:\/\//", $url)) {
                $url = $this->_urlBuilder->getBaseUrl(['_type' => UrlInterface::URL_TYPE_MEDIA]) . 'email/images/' . $url;
            }
        ...
        $html .= '<br>';
        $html .= htmlentities($this->getImgSrc(), ENT_QUOTES);
        $html .= '<br>';
    ...
    /**
     * Return html code of img src to be able to use at mail template
     * 
     * @return string
     */
